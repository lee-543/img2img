...
def main(args):
    ...
    tokenizer = AutoTokenizer.from_pretrained("../sd-turbo", subfolder="tokenizer", revision=args.revision, use_fast=False,)
    noise_scheduler_1step = make_1step_sched()
    text_encoder = CLIPTextModel.from_pretrained("../sd-turbo", subfolder="text_encoder").cuda()
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if global_step % args.checkpointing_steps == 1:
                        ...
                        sd["unet_lora_target_modules"] = l_modules_unet_encoder + l_modules_unet_decoder
