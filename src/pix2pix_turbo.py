...
class Pix2Pix_Turbo(torch.nn.Module):
    def __init__(self, pretrained_name=None, pretrained_path=None, ckpt_folder="checkpoints", lora_rank_unet=8, lora_rank_vae=4):
        super().__init__()
        self.tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/sd-turbo", subfolder="tokenizer")
        self.text_encoder = CLIPTextModel.from_pretrained("/root/autodl-tmp/sd-turbo", subfolder="text_encoder").cuda()
        self.sched = make_1step_sched()

        vae = AutoencoderKL.from_pretrained("/root/autodl-tmp/sd-turbo", subfolder="vae")
        ...
        unet = UNet2DConditionModel.from_pretrained("/root/autodl-tmp/sd-turbo", subfolder="unet")
