...
def main(args):
    ...
    tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/sd-turbo", subfolder="tokenizer", revision=args.revision, use_fast=False,)
    noise_scheduler_1step = make_1step_sched()
    text_encoder = CLIPTextModel.from_pretrained("/root/autodl-tmp/sd-turbo", subfolder="text_encoder").cuda()
